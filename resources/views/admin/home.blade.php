                ...
                <div class="container-home-data">
                    <div class="container-home-data__box">
                        <div class="container-home-data__box-item">
                            ...
                            <p class="container-home-data__box-item-core">{{ isset($order) ? count($order) : '' }}</p>
                        </div>
                    ...
                    <div class="container-home-data__box">
                        <div class="container-home-data__box-item">
                            ...
                            <p class="container-home-data__box-item-core">{{   isset($totalRevenue) ? number_format($totalRevenue, 0, '', ',') : ''}} đ</p>
                        </div>
                    ...
                    <div class="container-home-data__box">
                        <div class="container-home-data__box-item">
                            ...
                            <p class="container-home-data__box-item-core">{{ isset($views) ? $views : '' }}</p>
                        </div>
                ...
                <div class="container-home-child">
                    ...
                    @foreach($Topbuy as $value)
                        <div class="container-home-child-top__product">
                            <img src="{{ url('images') }}/{{ $value->image }}" alt="" class="container-home-child-top__product-img">
                            <div class="container-home-child-top__product-info">
                                <p class="container-home-child-top__product-name">Tên cây: {{$value->name}}</p>
                                <p class="container-home-child-top__product-name">Giá bán: {{ number_format($value->sale_price, 0, ".", ".") }}đ</p>
                            </div>
