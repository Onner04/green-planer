                ...
                <div class="slide-move">
                       <div class="slide-move__item active">
                           <a href="" class="slide-move__item-link">
                                 <img class="slide-move__item-img"  src="{{ url('fontend')}}/img/image.png"alt="">
                           </a>
                       </div>
                       <div class="slide-move__item">
                          <a href="" class="slide-move__item-link">
                                <img class="slide-move__item-img" src="{{ url('fontend')}}/img/4.jpg"alt="">
                          </a>
                      </div>
                      <div class="slide-move__item">
                          <a href="" class="slide-move__item-link">
                                <img class="slide-move__item-img" src="{{ url('fontend')}}/img/3.jpg"alt="">
                          </a>
                      </div>
