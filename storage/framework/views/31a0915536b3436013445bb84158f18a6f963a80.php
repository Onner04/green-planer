                    ...
                    <ul class="nav-bar-list">
                        ...
                        <li class="nav-bar-list-child nav-list-child-select">
                            <div class="nav-bar-list-child__content ">
                                ...
                                <a href="<?php echo e(route('order.index')); ?>" class="nav-bar-list-child__content-title">Quản lý đơn hàng</a>
                            </div>
...
<?php /**PATH D:\code\laravel\Green-planer\resources\views/admin/layout/menu.blade.php ENDPATH**/ ?>