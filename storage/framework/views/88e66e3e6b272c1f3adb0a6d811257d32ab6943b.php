                ...
                <div class="grid wide">
                    <div class="row">
                        <div class="col l-3 m-6 c-6 contact-item_padding">
                            <div class="contact-item">
                                <a class="contact-item_link" href="">
                                    <img class="contact-item_img" src="<?php echo e(url('fontend')); ?>/img/freeship.png" alt="">
                        ...
                        <div class="col l-3 m-6 c-6 contact-item_padding">
                            <div class="contact-item">
                                <a class="contact-item_link" href="">
                                    <img class="contact-item_img" src="<?php echo e(url('fontend')); ?>/img/antoan.png" alt="">
                        ...
                        <div class="col l-3 m-6 c-6 contact-item_padding">
                            <div class="contact-item">
                                <a class="contact-item_link" href="#">
                                    <img class="contact-item_img" src="<?php echo e(url('fontend')); ?>/img/call.png" alt="">
                        ...
                        <div class="col l-3 m-6 c-6 contact-item_padding">
                            <div class="contact-item">
                                <a class="contact-item_link" href="">
                                    <img class="contact-item_img" src="<?php echo e(url('fontend')); ?>/img/thuhang.png" alt="">
