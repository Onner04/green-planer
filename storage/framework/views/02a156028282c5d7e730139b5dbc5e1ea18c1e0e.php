          ...
          <div class="body-add-box">
              ...
              <form action="" method="POST">
                ...
                <div class="body-box-add-select">
                    ...
                    <input type="text" value="<?php echo e($cateChild->name); ?>" name="name" placeholder="Nhập tên menu" class="box-add-select-input">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\code\laravel\Green-planer\resources\views/admin/category-child/update.blade.php ENDPATH**/ ?>